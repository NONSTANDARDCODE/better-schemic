...
A SurrealDB-only fork of [Schemic](https://github.com/schemichq/schemic) — see `CHANGELOG.md` for the
...
dynamic driver loading by `config.driver`) + the SurrealDB driver package (`@schemic/surrealdb`)
