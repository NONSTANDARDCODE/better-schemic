...
const manifest = {
  $comment:
    "GENERATED by scripts/gen-examples-manifest-orm.ts — do not hand-edit. See packages/core/docs/EXAMPLE-COOKBOOK-CONVENTION.md.",
  source: { commit, hash },
  entries,
};

const out = join(import.meta.dir, "..", "examples-manifest-orm.json");
