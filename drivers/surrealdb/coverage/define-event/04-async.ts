...
export default cover(import.meta.url, {
  ...
  note: "`async: true` emits a bare `ASYNC` so the event runs asynchronously. SurrealDB materializes RETRY 1 / MAXDEPTH 3 defaults, which Better-schemic strips on emit so a bare ASYNC round-trips churn-free.",
