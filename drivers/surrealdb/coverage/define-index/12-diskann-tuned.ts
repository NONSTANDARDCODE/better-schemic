...
export default cover(import.meta.url, {
  ...
  note: "All DiskANN knobs Better-schemic authors: `dist`, `type`, `degree`, `l_build`, `alpha`. (The engine's `HASHED_VECTOR` flag has no `s.*` authoring yet.) Emitted as `DIST … TYPE … DEGREE … L_BUILD … ALPHA …`.",
